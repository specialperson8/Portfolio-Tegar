...
export default function App({ Component, pageProps }) {
	...
	const title = "Tegar Alam Qushoyyi | Portfolio";
	const description =
		"Halo! Saya Tegar Alam Qushoyyi, seorang pengembang web dan pemecah masalah yang bersemangat. Selamat datang di portofolio saya";
	const avatar =
