...
function About() {
  return (
    ...
    >
      ...
      >
        <div>
        Halo, saya Tegar Alam Qushoyyi, seorang Website Developer dan mahasiswa di Politeknik Negeri Jember. Selain menjalani studi, saya juga bekerja sebagai freelancer dengan spesialisasi di bidang Front-End dan Back-End development. Saya memiliki keahlian dalam berbagai bahasa pemrograman dan framework seperti PHP, HTML, CSS, JavaScript, Saya juga menggunakan Framework Laravel, CodeIgniter untuk Pengembangan Website.
          <br className="sm:block hidden" />
          Mari berkolaborasi untuk mewujudkan ide Anda!
        </div>
        <div className="w-fit break-words">
          <Link
            href="mailto:tegaralam387@gmail.com"
            target="_blank"
            rel="noreferrer"
