    ...
    <section className="xl:my-36 md:mx-36 p-8 " id="projects">
      ...
      <div className="w-full flex">
        <motion.p
          ...
          viewport={{ once: true, amount: 0.25 }}
        >
          Proyek-proyek ini menunjukkan keterampilan dan pengalaman praktis saya, masing-masing
          deskripsi dan tautan ke repositori kode dan demo langsung. Mereka
          menunjukkan kemampuan saya untuk menangani tantangan yang kompleks, beradaptasi
          teknologi yang berbeda, dan mengawasi proyek dari awal sampai akhir.
        </motion.p>
      </div>
